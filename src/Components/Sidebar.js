...
function Sidebar () {
    ...
    const [toogleUtilites,setToogleUtilites] = useState(false);
...
const handleCollapseUtilites = ()=>{
    setToogleUtilites(!toogleUtilites);
    var mycollapse = document.getElementById("collapseUtilites");
var bsCollapse=new Collapse (mycollapse);
toogleUtilites ? bsCollapse.show() : bsCollapse.hide()
};
...
const handleCollapseSideBar = ()=>{
    ...
    var mycollapse = document.getElementById("sidebarToggle");
var bsCollapse=new Dropdown (mycollapse);
toogleSideBar ? bsCollapse.show() : bsCollapse.hide()
};
...
{/* 
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" onClick={handleCollapseUtilites} data-toggle="collapse" data-target="#collapseUtilities"
            aria-expanded="true" aria-controls="collapseUtilities">
            <i class="fas fa-fw fa-wrench"></i>
            <span>Utilities</span>
        </a>
        <div id="collapseUtilites" class="collapse" aria-labelledby="headingUtilities"
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <Link class="collapse-item" to="/errorpage">404 Page</Link>
    ...
    <div class="text-center d-none d-md-inline">
        <button class="rounded-circle border-0" id="sidebarToggle" onClick={handleCollapseSideBar}></button>
    </div>
{/* 
    <!-- Sidebar Message --> */}
