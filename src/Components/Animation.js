...
function Animation() {
    ...
    const handleCollapseAnimation = () => {
      setToogleAnimation(!toogleAnimation);
      var mycollapse = document.getElementById("navbarDropdown");
      var bsCollapse = new Dropdown(mycollapse);
      toogleAnimation ? bsCollapse.show() : bsCollapse.hide();
    };

    const [toogleAnimations, setToogleAnimations] = useState(false);
    const handleCollapseAnimations = () => {
      setToogleAnimations(!toogleAnimations);
      var mycollapse = document.getElementById("dropdownMenuButton");
      var bsCollapse = new Dropdown(mycollapse);
      toogleAnimations ? bsCollapse.show() : bsCollapse.hide();
    };
                      ...
                      <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                          <a
                            ...
                            aria-haspopup="true"
                            aria-expanded="false"
                            onClick={handleCollapseAnimation}
                          >
                            Dropdown
                          </a>
                          <div
                  ...
                  <div class="card-body">
                    ...
                    <div class="dropdown mb-4">
                      <button
                        ...
                        aria-haspopup="true"
                        aria-expanded="false"
                        onClick={handleCollapseAnimations}
                      >
                        Dropdown
                      </button>
                      <div
