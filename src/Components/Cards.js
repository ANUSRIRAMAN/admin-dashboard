...
function Cards() {
  const [toogleCards, setToogleCards] = useState(false);
  const handleCollapseCards = () => {
    setToogleCards(!toogleCards);
    var mycollapse = document.getElementById("dropdownMenuLink");
    var bsCollapse = new Dropdown(mycollapse);
    toogleCards ? bsCollapse.show() : bsCollapse.hide();
  };


  const[toggleCardComponent,setToggleCardComponent]= useState(false);
  const handleCollapseCardComponent = () =>{
setToggleCardComponent(!toggleCardComponent)
var mycollapse = document.getElementById("collapseCardExample");
var bsCollapse = new Collapse(mycollapse);
toggleCardComponent ? bsCollapse.show() : bsCollapse.hide();
              ...
              <div class="col-lg-6">
                ...
                <div class="card shadow mb-4">
                  ...
                  <a
                    ...
                    onClick={handleCollapseCardComponent}
                    aria-expanded="true"
